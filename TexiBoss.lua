...
Main:Toggle({
    ...
    Callback = function(v)
        ...
        local Deliver = ReplicatedStorage.Quests.DeliveryComplete
        local Start = ReplicatedStorage.Quests.Contracts.StartContract
        local Cancel = ReplicatedStorage.Quests.Contracts.CancelContract
        local Complete = ReplicatedStorage.Quests.Contracts.CompleteContract
            ...
            task.spawn(function()
                while Dupe do
                    ...
                    pcall(function()
                        ...
                        if v then
                            Cancel:InvokeServer(v.Name)
                        end
                    end)

                    if not LocalPlayer.ActiveQuests:FindFirstChild("contractBuildMaterial") then
                        Start:InvokeServer("contractBuildMaterial")
                        repeat task.wait() until LocalPlayer.ActiveQuests:FindFirstChild("contractBuildMaterial") or not Dupe
                    end
                    ...
                    if quest then
                        ...
                        until quest.Value == "!pw5pi3ps2" or not Dupe
                        pcall(function()
