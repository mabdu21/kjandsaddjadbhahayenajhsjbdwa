...
        Rayfield:Notify({
            Title = "Completed",
            Content = "Loaded " .. loaded .. "/" .. total .. " Scripts",
            Duration = 3,
            Image = "download"
        })
    end
...
CombatTab:CreateSection("Feature Stand")
...
    Name = "Legendary Traits Priority",
...
local ReloadAllButton = SettingsTab:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({
            Title = "Reload Script",
            Content = "Already reload " .. loaded .. "/" .. total .. " scripts",
            Duration = 3,
            Image = "refresh-cw"
        })
    end
