...
local GameConfig = {
    ["Karate"] = {
        ["rbxassetid://105109868069470"] = {
            ["DisplayName"] = "2ndM1",
        },
        ["rbxassetid://111317285324171"] = {
            ["DisplayName"] = "4thM1",
        },
        ["rbxassetid://86918714359440"] = {
            ["DisplayName"] = "3rdM1",
        },
        ["rbxassetid://130884585830171"] = {
            ["DisplayName"] = "M2",
            ["ParryTime"] = 0.3,
        },
        ["rbxassetid://77957614227468"] = {
            ["DisplayName"] = "1stM1",
        },
        ["M1Time"] = 0.08
    },
    ...
    ["Wrestling"] = {
        ["rbxassetid://103849336431154"] = {
            ["DisplayName"] = "4thM1",
        },
        ["rbxassetid://132178222366446"] = {
            ["DisplayName"] = "1stM1",
        },
        ["rbxassetid://128114472490928"] = {
            ["DisplayName"] = "2ndM1",
        },
        ["rbxassetid://138624221040888"] = {
            ["DisplayName"] = "3rdM1",
        },
        ["rbxassetid://134616225320869"] = {
            ["DisplayName"] = "M2",
            ["ParryTime"] = 0.3,
        },
    },
    ...
    ["Capoeira"] = {
        ["rbxassetid://114254289386168"] = {
            ["DisplayName"] = "M2",
        },
        ["rbxassetid://85098647244472"] = {
            ["DisplayName"] = "4thM1",
        },
        ["rbxassetid://127253080182564"] = {
            ["DisplayName"] = "3rdM1",
        },
        ["rbxassetid://97280263199117"] = {
            ["DisplayName"] = "1stM1",
        },
        ["rbxassetid://136563726541554"] = {
            ["DisplayName"] = "2ndM1",
        },
    },

    ["Boxing"] = {
        ["rbxassetid://140559915903523"] = {
            ["DisplayName"] = "2ndM1",
        },
        ["rbxassetid://82164598010704"] = {
            ["DisplayName"] = "4thM1",
        },
        ["rbxassetid://103379337847201"] = {
            ["DisplayName"] = "M2",
            ["ParryFunction"] = function(mob, anim)
                task.wait(.15)
                Dodge()
                BlockStart(1)
            end,
        },
        ["rbxassetid://73977397773505"] = {
            ["DisplayName"] = "1stM1",
        },
        ["rbxassetid://82475370801539"] = {
            ["DisplayName"] = "3rdM1",
        },
        ["M1Time"] = 0.08,
    },
    ...
    ["MuayThai"] = {
        ["rbxassetid://87171697393871"] = {
            ["DisplayName"] = "1stM1",
        },
        ["rbxassetid://73865503612362"] = {
            ["DisplayName"] = "3rdM1",
        },
        ["rbxassetid://75692393601509"] = {
            ["DisplayName"] = "4thM1",
        },
        ["rbxassetid://101188641038819"] = {
            ["DisplayName"] = "M2",
            ["ParryTime"] = 0.3,
        },
        ["rbxassetid://140530278540076"] = {
            ["DisplayName"] = "2ndM1",
        },
        ["M1Time"] = 0.08
    },
    ...
    ["Basic"] = {
        ["rbxassetid://139875456638239"] = {
            ["DisplayName"] = "3rdM1",
        },
        ["rbxassetid://95363684987743"] = {
            ["DisplayName"] = "2ndM1",
        },
        ["rbxassetid://133112087379005"] = {
            ["DisplayName"] = "4thM1",
        },
        ["rbxassetid://95267170062803"] = {
            ["DisplayName"] = "1stM1",

        },
        ["rbxassetid://128479795877497"] = {
            ["DisplayName"] = "M2",
            ["ParryTime"] = 0.3,
        },
        ["M1Time"] = 0.09,
    ...
    ["Hakari"] = {
        ["rbxassetid://127631232991111"] = {
            ["DisplayName"] = "2ndM1",
        },
        ["rbxassetid://71447243477669"] = {
            ["DisplayName"] = "3rdM1",
        },
        ["rbxassetid://95359912376713"] = {
            ["DisplayName"] = "1stM1",
        },
        ["rbxassetid://73898520591442"] = {
            ["DisplayName"] = "4thM1",
        },
        ["rbxassetid://137330597899886"] = {
            ["DisplayName"] = "M2",
            ["ParryTime"] = 0.4,
        },
        ["M1Time"] = 0.23,
    ...
    ["Slugger"] = {
        ["rbxassetid://83785650808219"] = {
            ["DisplayName"] = "4thM1",
        },
        ["rbxassetid://135304344348112"] = {
            ["DisplayName"] = "1stM1",
        },
        ["rbxassetid://116328113967477"] = {
            ["DisplayName"] = "M2",
            ["ParryTime"] = 0.3,
        },
        ["rbxassetid://73329541283787"] = {
            ["DisplayName"] = "3rdM1",
        },
        ["rbxassetid://136278929175728"] = {
            ["DisplayName"] = "2ndM1",
        },
    },
}
...
local ClipboardSection = AP_Tab:Section("Logging", "Right")

local ConfigSection_Left = Config_Tab:Section("Left", "Left")
local ConfigSection_Right = Config_Tab:Section("Right", "Right")
...
local TargetFacingYou = AP_Section:Toggle("Target facing you", false)
local YouFacingTarget = AP_Section:Toggle("You facing target", true)
...
local StyleSliders = {}
local function CreateStyleSliders()
    local Number = 1
    for animationId, Info in GameConfig do  
        ...
        if not StyleSliders[StyleName] then
            local Section = (Number % 2 == 1) and ConfigSection_Left or ConfigSection_Right
            
            StyleSliders[StyleName] = {
                Animations = { Info }
            }
            
            Section:Slider("Parry Time For " .. tostring(StyleName), Info.M1Time, 0.01, 0, 1, "", function(v)
                for _, animInfo in ipairs(StyleSliders[StyleName].Animations) do
                    animInfo.ParryTime = v
                end
            end)

            Number += 1
        else
            table.insert(StyleSliders[StyleName].Animations, Info)
        end
    end
end
...
local function CreateAPSection()
    ...
    local Release = AP_Section:Slider("Default Release Time", 0.3, 0.01, 0, 1, "", function(v)
        ReleaseTime = v
    end)
    Release:Set(ReleaseTime)
end

local function CreateClipboardSection()
    local DamageLogToggle = ClipboardSection:Toggle("Damage Logs", false, function(on)
        ToggleDamageLogger(on)
    end)

    local CopyButton = ClipboardSection:Button("Copy to clipboard", function()
        SetClipboardLoggedCache()
    end)

    local ClearCache = ClipboardSection:Button("Clear animation cache", function()
...
local function checkRange(Studs, Origin : Part)
...
local function ListenForOrbs()
	...
	connection = RunService.RenderStepped:Connect(function()
        ...
        local ActiveOrbs = {}
        for i, v in game.Workspace.Thrown:GetChildren() do  
            if v.Name == "ArdourBall2" or v.Name == "ArdourBall" then  
		...
		for i = #ActiveOrbs, 1, -1 do
			...
			if orb and orb.Parent then
				...
				if distance <= PARRY_DISTANCE and (tick() - lastParryAt >= 0.1) then
					lastParryAt = tick()
...
local function ParryTask()
    ...
    if KeyHeld then
        -- I am currently holding the block button. Has my timer run out? Is it time to let go?
        local isExpired = (now >= ReleaseDeadline)
     --   local isSafetyTimeout = (now - LastParryTime >= ReleaseTime)
        
        if isExpired or ParrySuccess then
   ...
   if PendingParryTimestamp then
        ...
        -- I am in the queue waiting to block. However, I've been stuck waiting for so long (latency) that the enemy's attack has already finished. I should throw this parry request in the trash.
        ...
        elseif not CooldownActive then
         --   print(string.format("[Debug] Executing parry! Latency: %.3fs", latency))
            ...
            -- Optional: print why it's waiting
            -- print("[Debug] Parry queued but state is busy (Cooldown/Hold)")
        end
    end
end
...
local function onLocalAnimationAdded(anim)
    ...
    if table.find(ParriedAnimation, animId) then  
        if parryIntentSnapshot then
            ...
            UI_Library:Notify(
                "Parry status", 
                "success! Evaluated at " .. timeStr .. " for " .. parryIntentSnapshot.Style .. " " .. parryIntentSnapshot.DisplayName
            )
            parryIntentSnapshot = nil 
        else
            UI_Library:Notify("Parry status", "success")
        end
        ParrySuccess = true
    ...
    for _, character in ipairs(TargetCharacters) do
            ...
            if Distance < AutoParryRange then 
                if EspTrackers[character] and EspTrackers[character].ChangeText then  
                    EspTrackers[character]:ChangeText("Name", "IN RANGE", COLOR_GREEN)  
                end
            else
                if EspTrackers[character] and EspTrackers[character].ChangeText then  
                    EspTrackers[character]:ChangeText("Name", "OUT OF RANGE", COLOR_RED)  
                end
            ...
            for index, anim in ipairs(activeAnimations) do
                ...
                -- 1. Initialize Registry Data if it's a brand new animation
                ...
                -- 2. Check for loops BEFORE doing time calculations
                ...
                local isHeavy = attackConfig.DisplayName == "M2" or (attackConfig.DisplayName == "Heavy" and AutoDodgeToggle.Get())
                ...
                if attackConfig.ParryFunction then
                    ...
                    task.spawn(function()
                        attackConfig.ParryFunction(character)                        
                    end)
                    continue
                end
                ...
                if currentTime >= parryStart and currentTime <= parryEnd then
                    -- Optional: regData.Processed = true -- Prevent spamming if you only want 1 block per window
...
UIS.InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == CycleKeybind then 
        CycleEvent()
    end
end)
